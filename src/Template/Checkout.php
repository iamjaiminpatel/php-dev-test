                ...
                <form method="post" accept-charset="utf-8" action="checkout" class="form" novalidate="novalidate">
                    <div class="frame">
                        ...
                        <div class="frame__contents">
                            ...
                            <div class="form-field">
                                <label class="form-field__label form-field-checkbox__note">
                                    <input type="checkbox" name="rise_n_shine_beta" value="1" id="rise_n_shine_beta"/>
                    ...
                    <div class="frame">
                        ...
                        <div class="frame__contents">
                            ...
                            <div class="form-field form-field--required">
                                <label class="form-field__label" for="billing_address_line1">Line 1: <span class="form-field__label-required"> (required)</span></label>
                                <div class="form-field__contents">
                                    <input type="text" name="billing_address_line1" autocomplete="off|address-line1" id="billing_address_line1" class="entry" value="" size="35" maxlength="255" placeholder="456 Main St" required/>
                                </div>
                            </div>
                            <div class="form-field form-field">
                                <label class="form-field__label" for="billing_address_line2">Line 2:</label>
                                <div class="form-field__contents">
                                    <input type="text" name="billing_address_line2" autocomplete="off|address-line2" id="billing_address_line2" class="entry" value="" size="35" maxlength="255" placeholder="Apt, Suite, Building"/>
                                </div>
                            </div>
                            <div class="form-field form-field--required">
                    ...
                    <div class="frame">
                        <div class="frame__contents">
                            <div class="form-field">
                                <div class="form-field__contents btn-place-order-wrapper">
                                    <input type="submit" name="place_order" id="place_order" class="btn-place-order" value="Place Order"/>
                                </div>
                            </div>
                        </div>
                    </div>    
